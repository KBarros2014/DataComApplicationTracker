...
- Create Angular project with ng: `ng new datacomapplicationtracker.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`datacomapplicationtracker.client.esproj`).
